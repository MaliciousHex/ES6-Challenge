...
// Parks
 const park1 = new Parks("Green Parks",1945,2000,80000);
 const park2 = new Parks("Blue Parks",1810,200000,14000);
 const park3 = new Parks("Red Parks",2005,300,15000);
 const parks = [park1,park2,park3];

 // Streets
 const street1 = new Streets("Soekarnoe-Hatta",1946,15000,5);
 const street2 = new Streets("Jenderal-Sudirman",1965,45000);
 const street3 = new Streets("Ermawan",2015,800,1);
 const streets = [street1,street2,street3];

 function park_report(arr){
 	console.log("===== Parks Report =====");
 	arr.forEach(cur => cur.treeDesinty() );

 	let totalAge=0;

 	arr.map(el => totalAge += el.calculateAge() );
